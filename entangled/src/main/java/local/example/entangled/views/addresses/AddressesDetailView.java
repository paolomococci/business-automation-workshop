package local.example.entangled.views.addresses;
...
@Route(value = "addresses-detail/:addressID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("admin")
public class AddressesDetailView
        extends Div
        implements BeforeEnterObserver {

    private final String ADDRESS_EDIT_ROUTE_TEMPLATE = "addresses-detail/%d/edit";
    ...
    private BeanValidationBinder<Address> addressBeanValidationBinder;
    ...
    public AddressesDetailView(@Autowired AddressService addressService) {
        ...
        addClassNames("addresses-detail-view", "flex", "flex-col", "h-full");
        ...
        addressGrid.addColumn(Address::getStreet).setAutoWidth(true);
        addressGrid.addColumn(Address::getPostalCode).setAutoWidth(true);
        addressGrid.addColumn(Address::getCity).setAutoWidth(true);
        addressGrid.addColumn(Address::getState).setAutoWidth(true);
        addressGrid.addColumn(Address::getCountry).setAutoWidth(true);

        addressGrid.setItems(query -> addressService.pageable(
        ...
        addressBeanValidationBinder = new BeanValidationBinder<>(Address.class);

        addressBeanValidationBinder.bindInstanceFields(this);
        ...
        save.addClickListener(e -> {
            try {
                ...
                addressBeanValidationBinder.writeBean(this.address);
    ...
    private void populateForm(Address value) {
        this.address = value;
        addressBeanValidationBinder.readBean(this.address);
    }
}
